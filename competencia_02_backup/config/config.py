...
MESES_TRAIN = list(range(201901, 202102))   # Entrenamiento Optuna (201901–202101)
MES_VALID = [202102]                        # Validación externa
MES_TEST_FINAL = [202104, 202106]           # Predicciones finales
